// Last time updated at 01 April 2014, 11:50:23
            ...
            function socketResponse(response) {
                ...
                if (response.mute || response.unmute) {
                    if (response.promptMuteUnmute) {
                        ...
                        fakeObject.isVideo = !session.audio && session.video;
    ...
    function setDefaults(connection) {
        ...
        connection.onmute = function(e) {
            ...
            if (e.isVideo && e.mediaElement) {
                ...
                e.mediaElement.setAttribute('poster', e.snapshot || '//www.webrtc-experiment.com/images/muted.png');
            }
